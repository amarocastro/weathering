...
namespace weathering.Config.HereWeather
{
	...
	{
		public static string HERE_WEATHER_URL = "https://weather.ls.hereapi.com/weather/1.0/report.json?product={product}&latitude={lat}&longitude={lng}&oneobservation=true&apiKey={key}";
